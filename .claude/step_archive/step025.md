# Step 25 - 기획 보강: Awwwards UX/UI·레이아웃 조사결과
...
- step021_planning_chunk*.md (기획 초안)
- step019_조사결과_chunk*.md (Awwwards 디자인 패턴 분석 결과)
...
- 보강된 결과를 step021_planning_chunk*.md에 덮어쓴다
