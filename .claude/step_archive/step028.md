# Step 28 - 구현 파일 인덱싱 (tokei)

## 실행 내용

step23 설계 결과를 기반으로 파일별 구현 계획을 수립하고 서브에이전트를 배정한다.

**필요한 파일:**

- step030_설계_chunk*.md (레이아웃 설계 결과)
- step031_설계_chunk*.md (전체 설계 결과)
...
```
step033_파일인덱스_chunk1.md (500줄 이하)
step033_파일인덱스_chunk2.md (500줄 이하)
step033_파일인덱스_chunk3.md (500줄 이하)
...
```
