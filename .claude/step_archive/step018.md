# Step 18 - Awwwards 데이터 수집

## 실행 내용

Step 17에서 선정된 URL을 Playwright로 방문하여 스크린샷과 텍스트를 수집한다.

**필요한 파일:**

- `.claude/step017_선정URL.md` (선정된 URL 목록)

## 수집 방법

`.claude/step017_선정URL.md`를 Read하여 URL 목록을 획득하고, 각 URL에 대해:
...
합리적인 선에서 최대한 많은 서브에이전트를 병렬로 사용한다 (URL별 병렬).
